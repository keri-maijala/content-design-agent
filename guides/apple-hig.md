...
If you’re a registered Apple developer, you can request additions or revisions to the
Apple Style Guide by using Feedback Assistant. Otherwise, you can email feedback to
ASGFeedback@group.apple.com. (We regret that we can’t respond to feedback.)
...
## Deleted entries
AirMac; buddy list; built-in graphics card; central memory; clip art; CLUT; cold start (n., v.), cold-start (adj.);
color lookup table; component video; composite video; creator types; dial in, dial in to (v.), dial-in (adj.); dial-up
(adj.); digital video recorder; dock connector; DVR; electromagnetic interference; EMI; enhanced definition (n.),
enhanced-definition (adj.); ExpressCard; family pack; Fast Ethernet (100Base-T); fax (n., v., adj.); FB-DIMM;
flat-blade screwdriver; flat-panel (adj.); Grab; grow box; HDV; heat sink; hexagonal-head screw; high bit (n.),
high-bit (adj.); high-order bit (n.); IM; instant message; Integrated Services Digital Network; interface card; IrDA;
ISDN; Kbyte; live link; lo-bit; lo-res; micro-DVI; million instructions per second; MiniDV; mini-DVI; MIPS; M-JPEG;
multiple scan (adj.); narrowband; newsgroup; nickel-metal-hydride; nonstartup disk; NVIDIA; on-the-go playlist;
outline font; PAL; P-code; peripheral card; read-only memory; ROM; SATA; script system; secondary cache,
second-level cache; Serial ATA; SIMM; single inline memory module; slot-loading (adj.); soft copy; S/PDIF; spin
down (v.); stationery; S-video; telecommunication; television monitor; Torx screwdriver; TOSLINK; touch-tone
(adj.); trackball; track list; tray-loading (adj.); TV monitor; twisted-pair cable; Type 1 font; type-ahead (n., adj.);
UFS; UNIX File System; utility program; video card; video jack; warm start (n.), warm-start (adj.); whir; word
wrap; World Wide Web; wraparound (n.); WWW; Y-adapter

## Changes to the June 2025 version

## New entries
Active Noise Cancellation; Adaptive Audio; Apple Intelligence; Apple M4 chip; Check In; Clean Up; deny list/allow
list; ear tip; Ear Tip Fit Test; Genmoji; hearing health; Image Playground; Image Wand; Reduce Interruptions;
share, send; Smart Reply; SSD; Transparency; wellbeing; Writing Tools

## Changed entries
AirPods; blacklist/whitelist (n., v.); generation; iPad; M-series chips; press; solid-state drive; third party (n.),
third-party (adj.)
...
## New entries
Action button; anti-replay value; APNs; Apple Pencil hover; Apple Trade In; Apple Vision Pro; Apps View;
Assistive Access; Audio Straps; battery level; battery life, battery lifespan; cellular (n., adj.); charge cable;
Compass Waypoints; cover glass; Crash Detection; Environment; Environments View; EyeSight; Fit Dial; frame;
Guest User; Guided Access; head band; headset; Home View; iCloud+; iCloud Shared Photo Library; lifespan;
Light Seal; Light Seal Cushion; Live Activities; look; Mac Virtual Display; M-series chips; nonce; optical inserts;
Optic ID; People View; Persona; Private Browsing; push notification; ray tracing (n.), ray-tracing (adj.), raytraced (adj.); Ring/Silent switch; seasons; spatial photo, spatial video; Stage Manager; top button; touch; True
Tone flash; Türkiye; up-to-date (adj.), up to date (pred. adj.); view; virtual keyboard; visionOS; window bar;
ZEISS Optical Inserts

## Changed entries
Airplane Mode; AirPods; Apple Pencil; Apple TV; Apple Watch; App Store; capitalization; desktop computer;
Digital Crown; disable (v.), disabled (adj.); display (n.); drag; Fall Detection; gestures; iPad; iPhone; laptop; Mac;
notebook computer; pinch (v.); portable computer; product names; RAW; rotate; screen; side button; Spatial
Audio; swipe (n., v.); system on a chip (n.), system-on-chip (adj.); tap (n., v.); via; window
...
## New entries
Apple Card; Apple Card Family; Apple Cash; Apple Cash Family; autism (n.), autistic (adj.); Daily Cash; Focus;
LiDAR; Live Text; man; More button, More menu; neurodivergence (n.), neurodivergent (adj.); neurodiversity (n.),
...
Apple T2 Security Chip; App Library; AssistiveTouch; Back button; black box/white box (n., adj.); black hat/white
hat; black/white; blind, low vision; closed captions (n.), closed captioning (n., adj.), closed-captioned (adj.);
color blind, color blindness; colored; deafblind, Deafblind; deaf or hard of hearing, Deaf; disability; dummy;
Forward button; grandfathered, grandfathered in; Guides; handicapped; hearing impaired; impairment; kill;
livestream (n., v.), livestreaming (n.); man-in-the-middle attack; master; master branch; master-detail (adj.);
mate; rotor; rule of thumb; sanity check, sanity test; SDH; sighted; Smart Stack; Spatial Audio; stream (n., v.),
streaming (n., adj.); surround sound (n., adj.); Today View; visually impaired; wheelchair user; Writing inclusively
...
analog Note spelling. Use hyphens in the adjectives analog-to-digital and digital-toanalog.
...
individual discs.
You can create Blu-ray video and audio files and burn them to a Bluray disc.
...
When you choose Gradient Fill, two color wells appear below the popup menu; select a color from each color well.
...
determine the format of links to chapters or sections within a document. For crossreferences that aren’t links, match the capitalization style of the chapter or section
...
On devices with a Home button, side button, top button, or Digital Crown, users doubleclick (not double-press) the button or Digital Crown.
...
The MPEG-2 format encodes MPEG-2 stream files for SD DVD and Bluray authoring.
See also file types.
...
controls, view full screen. OK to use full-screen window to refer to a window that’s in fullscreen view: This action has no effect on a full-screen window.
...
lowercase.
Fusion Drive A storage technology consisting of flash storage combined with a highcapacity hard drive. See also drive.
...
To remove keyword presets 1 through 8, press Option-Shift-1, OptionShift-2, and so on.
...
through the localization process, which involves revision and translation for non-Englishspeaking users.
...
lock Users lock files, apps, or devices; they write-protect their disks. Disks are copyprotected by the manufacturer.
...
down arrows (or just a down arrow). For pop-up menus, use the style Click the X popup menu, and then choose Y.
...
display, Multi-Touch interface, Multi-Touch technology, Multi-Touch trackpad, and MultiTouch gestures.
...
Phillips screw, Phillips screwdriver Note spelling. Not Phillips-head screw or Phillipshead screwdriver.
...
Walkie-Talkie A watchOS app. Don’t use as a verb; say use Walkie-Talkie, have a WalkieTalkie conversation, or similar.
...
Note: Some people may use the
term visually impaired. If you’re
writing about someone specific, ask
them what they prefer.
A deaf person
Note: Use Deaf (with a capital D) to
...
An autistic person
Autistic people
Note: Some people who identify
culturally as autistic capitalize the
A—for example, an Autistic person.
...
identity-first language to personfirst language. However, if you’re
writing about someone specific, ask
them what they prefer.
...
Apple Style Guide  Copyright © 2026 Apple Inc. All rights reserved.
...
AirPort Extreme, AirPort Time Capsule, AirTag, Animoji, Apple Books, Apple Card, Apple Cash, Apple Music,
Apple News, Apple Pay, Apple Pencil, Apple Pencil Pro, Apple Pro Display XDR, AppleScript, Apple Studio Display,
Apple TV, Apple Vision Pro, Apple Watch, Apple Watch Ultra, AssistiveTouch, CarPlay, Cocoa, Cover Flow, Digital
Crown, Dynamic Island, Face ID, FaceTime, Final Cut Pro, Finder, Find My, FireWire, Force Touch, Freeform,
GarageBand, Guided Access, Handoff, HomePod, HomePod mini, iBooks, iMac, iMessage, iMovie, iPad, iPad Air,
iPad mini, iPadOS, iPad Pro, iPhone, iPod, iPod classic, iPod nano, iPod shuffle, iPod touch, iTunes, iTunes U,
iWork, Keychain, Keynote, Launchpad, Lightning, Liquid Retina, Live Activities, Live Listen, Live Photos, Live Text,
Mac, MacBook, MacBook Air, MacBook Pro, Mac Catalyst, Macintosh, Mac mini, macOS, Mac Pro, Mac Studio,
Mac Virtual Display, Magic Keyboard, Magic Mouse, Magic Trackpad, Memoji, Metal, Mission Control, Motion,
Numbers, Optic ID, OS X, Pages, Pro Stand, ProRes, QuickTime, Retina, Safari, SharePlay, Shazam, Sidecar, Siri,
Siri Remote, Siri Shortcuts, Spaces, Spotlight, Stage Manager, Studio Display, SuperDrive, Tapback, Taptic Engine,
3D Touch, Time Machine, Touch Bar, Touch ID, TrueDepth, True Tone, tvOS, visionOS, watchOS, Xcode, and Xsan
are trademarks of Apple Inc., registered in the U.S. and other countries and regions.
Apple Creator Studio, Apple Immersive Video, Apple Intelligence, Apple Remote Desktop, Genmoji, Image
Playground, and Multi-Touch are trademarks of Apple Inc.
App Store, AppleCare, AppleCare+, Apple Fitness+, Apple News+, Apple One, Apple Podcasts, Apple Store, Apple
Trade In, Apple TV+, Daily Cash, Genius, iCloud, iCloud Drive, iCloud+, and iTunes Store are service marks of
...
ENERGY STAR and the ENERGY STAR mark are registered trademarks owned by the U.S. Environmental Protection
Agency.
